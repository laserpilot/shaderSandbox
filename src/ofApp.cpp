...
void ofApp::draw(){
    ...
    ofTexture fboTex1;
    fboTex1 = brcosaFbo.getTexture(); //I did it this way because using it as brcosaFbo.getTextureReference().bind() wasnt working correctly
    ...
    ///BRCOSA FBO Processed by Bloom shader-------------------------------------
    ofTexture fboTex2;
    fboTex2 = chromaFbo.getTexture(); //I did it this way because using it as brcosaFbo.getTextureReference().bind() wasnt working correctly
    //Mix brcosa with bloom
